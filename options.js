...
function save_options() {
  ...
  const auto_tags = convertTextAreaToArray(document.getElementById("auto_tags"));
...
function restore_options() {
  chrome.storage.sync.get(
    ...
    function (items) {
      ...
      setTextAreaValueByArray(document.getElementById("projects"), items.projects);
      setTextAreaValueByArray(document.getElementById("auto_tags"),items.auto_tags);
      document.getElementById("load_pages").checked = items.load_pages;
      document.querySelectorAll('#project-container .project-tests-container').forEach(div => div.remove());
      items.projects.forEach(project => {
        ...
        if (items.project_test_requirements.hasOwnProperty(project)) {
          setTextAreaValueByArray(projectTests, items.project_test_requirements[project])
        }
